...
namespace StressTest
{
    ...
    public class StressTestCase
    {
        ...
        public void PerformStressTest()
        {
            ...
            string[] failureReasons = { "Обнаружен перелом", "Луч щелкнул", "Неправильные размеры балки", "Перекосившаяся балка", "Другой" };
        ...
        public override string ToString()
        {
            ...
            if (testCaseResult.HasValue)
            {
                stressTestPerformed = "Стресс-Тест Завершен";
            }
            else
            {
                stressTestPerformed = "Стресс-Тест Не Проводился";
            }
            return string.Format("Материал: {0}, Поперечное сечение: {1}, Длина: {2}mm, Высота: {3}mm, Ширина: {4}mm, {5}",
